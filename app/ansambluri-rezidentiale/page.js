            ...
            <div className="flex items-end justify-between flex-wrap gap-4">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  ...
                  {filtreActive && <button onClick={resetFiltre} className="ml-2 text-xs underline" style={{ color: '#2d7a3a' }}>Resetează filtrele</button>}
                </p>
              </div>
              {/* VIEW TOGGLE */}
              ...
              <div className="bg-white rounded-xl border border-gray-100 p-5 sticky top-[82px]">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {camereDinDate.map(c => (
                      <button key={c} onClick={() => setCamere(c)}
                        ...
                        {c === '1' ? 'Garso/Studio' : c === 'Toate' ? 'Toate' : `${c} cam.`}
                      </button>
                    ))}
                  </div>
                </div>
                ...
                {filtreActive && (
                  <button onClick={resetFiltre}
                    className="w-full py-2 rounded-lg text-xs border border-gray-200 text-gray-500 hover:bg-gray-50 transition-colors">
                    Resetează toate
                  </button>
                )}
              </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              {filtered.length === 0 ? (
                <div className="bg-white rounded-xl border border-gray-100 p-12 text-center">
                  <p className="text-gray-400 text-sm mb-3">Niciun ansamblu nu corespunde filtrelor selectate.</p>
                  <button onClick={resetFiltre}
                    ...
                    return (
                      <Link key={a.slug} href={`/ansamblu-rezidential/${a.slug}`}
                        ...
                        <div className="p-4">
                          ...
                          <h3 className="text-sm font-medium text-gray-900 mb-2 group-hover:text-green-700 transition-colors">
                            {a.nume}
                          </h3>
                      ...
                      <Link key={a.slug} href={`/ansamblu-rezidential/${a.slug}`}
                        ...
                        <div className="flex-1 p-4 min-w-0">
                          ...
                          <div className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-gray-500">
                            ...
                            {a.dataPredare && <><span>·</span><span>Predare {a.dataPredare}</span></>}
                          </div>
