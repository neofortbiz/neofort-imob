              ...
              {step === 4 && (
                <div style={{ textAlign: 'center', padding: '8px 0 8px' }}>
                  ...
                  <a href={`https://wa.me/40758090904?text=${encodeURIComponent(`Bună ziua! Am trimis o cerere de credit pe neofort.ro. Numele meu este ${fNume}.`)}`}
                    ...
                    style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, background: '#1a7d33', color: '#fff', borderRadius: 12, padding: '12px', fontSize: 14, fontWeight: 600, textDecoration: 'none', marginBottom: 10 }}>
