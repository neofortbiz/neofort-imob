...
export const metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: '/icon-512.avif', sizes: '512x512', type: 'image/avif' },
    ],
    apple: '/apple-touch-icon.png',
  },
  title: {
    default: 'Ansambluri Rezidențiale Noi București — Neofort IMO',
    template: '%s | Neofort IMO',
  },
  description: `Ansambluri rezidențiale noi în București, direct de la sursă, fără comision. ${NR_ACTIVE} ansambluri active în Sectoarele 2, 3 și 6. ${ANI_EXPERIENTA} ani experiență, ${NR_LIVRATE}+ proiecte livrate. Sună: 0758 090 904.`,
  keywords: [
    'ansambluri rezidentiale bucuresti', 'apartamente noi bucuresti',
  ...
  openGraph: {
    ...
    title: 'Ansambluri Rezidențiale Noi București — Neofort IMO',
    description: `Ansambluri rezidențiale noi în București, direct de la sursă, fără comision. ${NR_ACTIVE} ansambluri active în Sectoarele 2, 3 și 6.`,
    url: BASE,
    images: [{ url: `${BASE}/og-image.jpg`, width: 1200, height: 630, alt: 'Ansambluri Rezidențiale Noi București' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Ansambluri Rezidențiale Noi București',
    description: `Ansambluri rezidențiale noi direct de la sursă, fără comision. ${NR_ACTIVE} ansambluri active.`,
...
const organizationSchema = {
  ...
  logo: {
    ...
    width: 1024,
    height: 701,
    caption: 'Ansambluri Rezidențiale Noi București',
  },
