  ...
  return (
    <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
      ...
      <div className="flex flex-col gap-1.5">
        <a
          href={`tel:${TEL}`}
          className="w-full py-2.5 rounded-lg border text-sm font-medium transition-colors hover:bg-blue-50 grid"
          style={{ borderColor: '#1565c0', color: '#1565c0', gridTemplateColumns: '20px 1fr' }}
        >
          <span className="flex items-center justify-center">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#1565c0" strokeWidth="2.5" strokeLinecap="round">
          ...
          <span className="text-center">{TEL_DISPLAY}</span>
        </a>
        <a
          href={WA_LINK}
          target="_blank"
          rel="noopener noreferrer"
          className="w-full py-2.5 rounded-lg border text-sm font-medium transition-colors hover:bg-green-50 grid"
          style={{ borderColor: '#25a244', color: '#25a244', gridTemplateColumns: '20px 1fr' }}
        >
          <span className="flex items-center justify-center">
        ...
        <a
          href="mailto:lead.neo@neofort-biz.ro"
          className="w-full py-2.5 rounded-lg border text-sm font-medium transition-colors hover:bg-yellow-50 grid"
          style={{ borderColor: '#c8922a', color: '#c8922a', gridTemplateColumns: '20px 1fr' }}
        >
          <span className="flex items-center justify-center">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#c8922a" strokeWidth="2" strokeLinecap="round">
              <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/>
              <polyline points="22,6 12,13 2,6"/>
            </svg>
          </span>
          <span className="text-center">Trimite email</span>
        </a>
      </div>
