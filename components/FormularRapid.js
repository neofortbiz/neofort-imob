  ...
  return (
    <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
      ...
      <div className="flex flex-col gap-1.5">
        <a
          href={`tel:${TEL}`}
          className="w-full py-2.5 rounded-lg border text-sm font-medium transition-colors hover:bg-blue-50 flex items-center justify-center gap-2.5 px-4"
          style={{ borderColor: '#1565c0', color: '#1565c0' }}
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#1565c0" strokeWidth="2.5" strokeLinecap="round" flexShrink="0">
        ...
        <a
          ...
          className="w-full py-2.5 rounded-lg border text-sm font-medium transition-colors hover:bg-green-50 flex items-center justify-center gap-2.5 px-4"
          style={{ borderColor: '#25a244', color: '#25a244' }}
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="#25a244" style={{ flexShrink: 0 }}>
        ...
        <a
          ...
          className="w-full py-2.5 rounded-lg border text-sm font-medium transition-colors hover:bg-yellow-50 flex items-center justify-center gap-2.5 px-4"
          style={{ borderColor: '#c8922a', color: '#c8922a' }}
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#c8922a" strokeWidth="2" strokeLinecap="round" style={{ flexShrink: 0 }}>
