    ...
    <header className="bg-white border-b border-gray-100 sticky top-0 z-50" style={{ overflow: "visible" }}>
      ...
      <div className="hidden md:flex items-center max-w-7xl mx-auto px-6 h-[82px] gap-6">
        <Link href="/" className="flex-shrink-0">
          <img src="/logo-small.jpg" alt="Neofort IMO — Imobiliare București" className="h-[63px] w-auto" width="92" height="63" />
        </Link>
      ...
      <div className="md:hidden">
        <div className="px-4 h-16 flex items-center justify-between">
          <Link href="/" className="flex-shrink-0">
            <img src="/logo-small.jpg" alt="Neofort IMO — Imobiliare București" className="h-14 w-auto" width="81" height="56" />
          </Link>
