...
const NAV_LINKS = [
  ...
  { href: '/calculator-credit', label: 'Calculator Credite' },
...
export default function Header({ activePath = '/' }) {
  ...
  const ContactIcons = () => (
    <div className="flex items-center gap-2 flex-shrink-0">
      <a href={`tel:${contact.tel}`} onClick={() => trackContact('tel', pathname, 'header')}
      ...
      <a href={contact.waLink} target="_blank" rel="noopener noreferrer" onClick={() => trackContact('whatsapp', pathname, 'header')}
      ...
      <a href={contact.emailLink || `mailto:${EMAIL}`} onClick={() => trackContact('email', pathname, 'header')}
