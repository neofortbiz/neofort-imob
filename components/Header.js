      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Hamburger mobil */}
            <button
              className="ml-1 w-9 h-9 rounded-lg border border-gray-200 bg-gray-50 flex items-center justify-center md:hidden"
        ...
        {/* NAV BAR */}
        <nav className="border-t border-gray-100 bg-gray-50 hidden md:block">
          <div className="max-w-7xl mx-auto px-6 flex nav-scroll overflow-x-auto">
            {NAV_LINKS.map(link => (
              <Link
                key={link.href}
                href={link.href}
