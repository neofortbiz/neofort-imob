...
export default function Header({ activePath = '/' }) {
  ...
  return (
    <>
      <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:z-[9999] focus:px-4 focus:py-2 focus:rounded-lg focus:text-sm focus:font-medium focus:text-white focus:bg-[#2d7a3a]">Sari la conținut</a>
