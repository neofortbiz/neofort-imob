...
export const ANSAMBLURI = [
  {
    ...
    puncteInteres: [
      ...
      { tip: 'mall', nume: 'Mega Image / magazine de proximitate', distanta: '3 min pe jos' },
      { tip: 'parc', nume: 'Parcul Național', distanta: '7 min pe jos' },
      { tip: 'parc', nume: 'Zona rezidențială case — liniște și verdeață', distanta: 'în zonă' },
      ...
      { tip: 'transport', nume: 'Tramvai 21 / STB multiple linii', distanta: '2 min pe jos' },
      { tip: 'mall', nume: 'Piața Muncii + cafenele Calea Călărașilor', distanta: '5 min pe jos' },
    ],
    galerie: [],
