...
Structura imobilului este realizată din cadre și diafragme din beton armat completate cu zidărie cărămidă Porotherm — unul dintre cele mai performante sisteme constructive disponibile, care asigură izolație termică și fonică superioară față de BCA sau panouri prefabricate. Dotările standard includ încălzire în pardoseală în toate camerele, tâmplărie PVC Salamander cu ferestre mari pentru lumină naturală maximă, lifturi silențioase, gresie și faianță de import, centrală termică proprie în condensare și instalații sanitare, electrice și termice complete.
...
Procesul de achiziție la Neofort 84 este simplificat și transparent. Rezervarea se face cu 2.000€, sumă restituibilă integral dacă nu se ajunge la antecontract din vina dezvoltatorului. Consultanța juridică și bancară este gratuită pe toată durata — Neofort IMO colaborează cu toate băncile majore din România pentru identificarea celui mai avantajos credit ipotecar. Prețurile promoționale la avans 45% sunt valabile pentru unități specifice și se pot modifica pe măsura avansării construcției. Vânzare directă de la sursă, fără comision de agenție.`,
    ...
    puncteInteres: [
      { tip: 'mall', nume: 'IKEA Pallady', distanta: '750m' },
      { tip: 'metrou', nume: 'Metrou Anghel Saligny (M2)', distanta: '950m' },
      ...
      { tip: 'medical', nume: 'Spital Clinic Fundeni', distanta: '15 min cu masina' },
    ],
    galerie: [],
...
Pentru investitori: chiria medie pentru o garsonieră de 43 mp în Titan cu metrou la 3 minute este de 450-550€/lună, reprezentând un randament brut de 8-10% față de prețul de achiziție de la 64.800€. Apartamentele de 2 camere generează chirii de 650-750€/lună — randament 7-8,5%. Cererea de chirie în zonă este susținută de angajații din zona de est și din centrul Bucureștiului care preferă metroul față de mașina personală. Rezervare cu 2.000€, consultanță bancară gratuită, vânzare directă fără comision.`,
    ...
    puncteInteres: [
      { tip: 'mall', nume: 'IKEA Pallady', distanta: '13 min pe jos' },
      { tip: 'metrou', nume: 'Metrou Anghel Saligny (M2)', distanta: '4 min cu masina' },
      { tip: 'medical', nume: 'Campus Medical Regina Maria Titan', distanta: '5 min cu masina' },
      { tip: 'metrou', nume: 'Metrou Nicolae Teclu (M2)', distanta: '6 min cu masina' },
      { tip: 'parc', nume: 'Parcul IOR (Titan)', distanta: '8 min cu masina' },
      { tip: 'metrou', nume: 'Metrou Costin Georgian (M2)', distanta: '9 min cu masina' },
      { tip: 'mall', nume: 'Park Lake Plaza', distanta: '10 min cu masina' },
      { tip: 'parc', nume: 'Parcul National 23 August', distanta: '14 min cu masina' },
    ],
    galerie: [],
  ...
  },
  {
    ...
    descriereCompleta: `Pe strada Ardeleni din zona Moșilor-Eminescu, Sectorul 2, la exact 400 de metri — 5 minute pe jos — de Metrou Piața Obor (M2), Neofort 78 Faza 2 propune ceva rar în oferta imobiliară a Bucureștiului: un proiect boutique de 22 de apartamente cu finisaje Premium-Lux, cu predare în Mai 2026, cu tipologii care merg de la 58 mp până la 495.000€ pentru un duplex exclusivist.
...
Neofort 78 Faza 2 este adresat unui segment specific de cumpărători: cei care înțeleg că un proiect de 22 de unități cu finisaje HansGrohe, Salamander Blue Edition și parchet stejar la 400m de metrou Obor este o oportunitate care nu se repetă. Proiectele boutique de această calitate în Sectorul 2 semicentral se vând integral în prima fază de lansare. Predare Mai 2026. Parcare subterană 30.000€ + TVA. Rezervare cu 2.000€, consultanță juridică și bancară gratuită. Vânzare directă de la sursă, fără comision de agenție.`,
    ...
    puncteInteres: [
      { tip: 'parc', nume: 'Parcul Plumbuita', distanta: '500m' },
      { tip: 'scoala', nume: 'Colegiul National Mihai Eminescu', distanta: '550m' },
      { tip: 'mall', nume: 'Veranda Mall Obor', distanta: '950m' },
      { tip: 'parc', nume: 'Lacul Tei / Parcul Tei', distanta: '13 min pe jos' },
      { tip: 'metrou', nume: 'Metrou Piata Obor (M2)', distanta: '14 min pe jos' },
...
Penthouse-ul Neofort 76 cu 276,98 mp și terasă panoramică la etajele 8-9 pe Bulevardul Iuliu Maniu este o propunere unică în Sectorul 6: nu există altă unitate comparabilă ca suprafață, etaj și localizare față de metrou în această zonă la prețul de 218.409€ + TVA. Prețul pe metru pătrat — aproximativ 788€/mp — este semnificativ sub media penthouse-urilor comparabile din Sectoarele 1 și 2, unde prețurile similare pornesc de la 1.500€/mp. Parcare sistem Klaus 10.000€ TVA inclus. Rezervare cu 2.000€. Consultanță juridică și bancară gratuită. Vânzare directă de la sursă, fără comision de agenție. Zona Militari-Iuliu Maniu continuă să se dezvolte susținut, cu investiții publice semnificative în infrastructura de transport și regenerare urbană.`,
    ...
    puncteInteres: [
      { tip: 'metrou', nume: 'Metrou Pacii (M3)', distanta: '350m' },
      { tip: 'metrou', nume: 'Metrou Preciziei (M3)', distanta: '900m' },
      { tip: 'mall', nume: 'Plaza Romania', distanta: '4 min cu masina' },
      { tip: 'mall', nume: 'AFI Palace Cotroceni', distanta: '4 min cu masina' },
      { tip: 'mall', nume: 'Militari Shopping Center', distanta: '5 min cu masina' },
      { tip: 'parc', nume: 'Parcul Liniei (Militari)', distanta: '5 min cu masina' },
      { tip: 'metrou', nume: 'Metrou Gorjului (M3)', distanta: '6 min cu masina' },
      { tip: 'mall', nume: 'Veranda Mall Obor', distanta: '22 min cu masina' },
    ],
    galerie: [],
...
De ce să alegi Neofort 56 Faza 2 față de alte proiecte similare din Titan? Trei argumente concrete: Smart Home Ready integrat standard fără costuri suplimentare — o dotare pe care alte proiecte o oferă ca opțiune la 3.000-5.000€ în plus; stațiile de încărcare EV în parcare — un avantaj operațional permanent pe măsură ce mobilitatea electrică se extinde; și apartamentul cu curte proprie de la parter — o configurație imposibil de găsit în alte imobile noi din zonă la prețul de 235.208€. Parcare 8.900€ TVA inclus. Rezervare cu 2.000€. Consultanță bancară gratuită. Vânzare directă fără comision.`,
    ...
    puncteInteres: [
      { tip: 'medical', nume: 'Campus Medical Regina Maria Titan', distanta: '450m' },
      ...
      { tip: 'parc', nume: 'Parcul National 23 August', distanta: '11 min cu masina' },
    ],
    galerie: [],
  ...
  },
  {
    ...
    descriereCompleta: `Există un criteriu pe care mulți cumpărători de apartamente noi în București îl consideră non-negociabil: metrou la maximum 5 minute pe jos. Neofort 50 Titan IOR nu doar că îndeplinește această condiție — o depășește: Metrou Costin Georgian (M2) se află la 1 minut de mers pe jos, ieșire directă la stradă.

Imobilul cu regim 2S+P+5E-6/11R este finalizat și disponibil imediat. Oferta cuprinde: 2 camere Scara 1, 73,10 mp, etajele 1-5, de la 142.545€; 2 camere cu terasă, 48,90 mp, etajul 6, de la 144.210€; 2 camere cu terasă mare, 56,40 mp, etajele 10-11, de la 176.904€; 4 camere cu terasă, 99,95 mp, etajele 10-11, de la 255.405€ în promoție. Parcare subterană și supraterană disponibile.

Construcția pe piloți cu adâncime de 17 metri este un standard tehnic de excepție care asigură stabilitatea maximă indiferent de natura terenului. Cele 4 lifturi ORONA KRONLIFT spatioase elimină problema timpilor de așteptare caracteristică imobilelor cu un singur lift. Cele 2 subsoluri rezolvă complet necesarul de parcare și depozitare. Adăpostul ALA cu 3 ieșiri de salvare autorizat ISU este o dotare obligatorie rar implementată corect în imobilele rezidențiale. Parcul de relaxare cu loc de joacă în incinta proprie și spațiile comerciale de la parter completează infrastructura internă.

Dotările apartamentelor sunt din gamele superioare: vitraje mari SALAMANDER tripan pentru lumină naturală maximă, uși PINUM și BENATI, obiecte sanitare ROCA, CERSANIT și GROHE în funcție de tip, centrală SAUNIER DUVAL by VAILLANT de înaltă eficiență, termostat wireless Smart și încălzire în pardoseală în toate camerele.

Parcul IOR — cunoscut și ca Parcul Titan, unul dintre cele mai mari parcuri din București — cu lac artificial, pârtie de schi artificială iarna, piste de biciclete, terenuri de tenis, bazin de înot și facilități complete de agrement — la 5 minute pe jos. Parcul Teilor la 10 minute, Parcul Titanii la 8 minute. Auchan Titan la 5 minute cu mașina, IKEA Pallady la 10 minute. Piața Morarilor și Piața Minis la 5 minute pe jos pentru cumpărăturile zilnice. Liceul Nichita Stănescu și Grădinița nr. 70 la 5 minute. Campus Medical Regina Maria la 10 minute. Bulevardul 1 Decembrie 1918 — magistrala principală a Sectorului 3 — cu linii STB multiple în față.

Metrou la 1 minut + Parc IOR la 5 minute + imobil finalizat disponibil imediat: o combinație pe care piața Sectorului 3 o oferă rar simultan.
...
Pentru investitori, zona Titan-IOR generează chirii lunare de 700-850€ pentru apartamentele de 2 camere și 1.200-1.500€ pentru cele de 4 camere, reprezentând randamente brute de 5,5-7% anual. Cererea de chirie este constantă, susținută de proximitatea față de metrou și parc. Consultanță bancară și juridică gratuită pe toată durata achiziției. Vânzare directă, fără comision.`,
    ...
    apartamente: [
      { tip: '2 cam. Scara I', etaj: 'et. 1-5', suprafata: 70.40, avans20: 161920, avans45: null, promo: false, camere: 2 },
      { tip: '2 cam. cu Terasa Scara I', etaj: 'et. 1-5', suprafata: 47.80, avans20: 153860, avans45: null, promo: false, camere: 2, suprTerasa: 54.90 },
      { tip: '2 cam. cu Terasa Scara I', etaj: 'et. 1-5', suprafata: 52.90, avans20: 162710, avans45: null, promo: false, camere: 2, suprTerasa: 51.30 },
      { tip: '2 cam. cu Terasa PROMO Scara I', etaj: 'et. 1-5', suprafata: 55.00, avans20: 196260, avans45: null, promo: true, camere: 2, pretPromo: 176900, suprTerasa: 87.20 },
      { tip: '4 cam. cu Terasa PROMO Scara II', etaj: 'et. 1-5', suprafata: 99.20, avans20: 304760, avans45: null, promo: true, camere: 4, pretPromo: 281810, suprTerasa: 91.90 },
    ],
    ...
    puncteInteres: [
      { tip: 'metrou', nume: 'Metrou Costin Georgian (M2)', distanta: '550m' },
      { tip: 'parc', nume: 'Parcul IOR (Titan)', distanta: '550m' },
      ...
      { tip: 'scoala', nume: 'Universitatea Hyperion', distanta: '9 min cu masina' },
    ],
    galerie: [],
...
Randamentul în chirie: garsonierele de 38-39 mp se închiriază în zona Militari cu metrou la 5 minute cu 350-430€/lună — randament brut 5,5-6,7% anual. Apartamentele de 2 camere generează 550-650€/lună — randament 5,5-6,5%. Stocul este limitat la 18 unități — disponibilitatea se poate reduce rapid. Parcare subterană 15.000€ TVA inclus. Rezervare cu 2.000€. Consultanță bancară și juridică gratuită. Vânzare directă de la sursă, fără comision de agenție. Zona Militari generează constant una dintre cele mai ridicate cereri de chirie din București, alimentată de angajații din zona de business a Sectorului 6, din centru și din zona Drumul Taberei conectată pe M5. Cu doar 18 unități disponibile, stocul se poate epuiza rapid.`,
    ...
    puncteInteres: [
      { tip: 'mall', nume: 'Militari Shopping Center', distanta: '650m' },
      { tip: 'mall', nume: 'Plaza Romania', distanta: '750m' },
      { tip: 'parc', nume: 'Parcul Liniei (Militari)', distanta: '850m' },
      { tip: 'metrou', nume: 'Metrou Preciziei (M3)', distanta: '950m' },
      { tip: 'metrou', nume: 'Metrou Gorjului (M3)', distanta: '3 min cu masina' },
      { tip: 'metrou', nume: 'Metrou Pacii (M3)', distanta: '4 min cu masina' },
      { tip: 'mall', nume: 'AFI Palace Cotroceni', distanta: '7 min cu masina' },
      { tip: 'mall', nume: 'Veranda Mall Obor', distanta: '19 min cu masina' },
    ],
    galerie: [],
...
Randamentul în chirie: 2 camere 62 mp se închiriază cu 600-750€/lună în zonă — randament 7-9% față de 100.208€; 3 camere 86 mp cu 800-950€/lună — randament 7-8,3% față de 137.919€. Eligibil Prima Casă și credite ipotecare standard cu avans 15-25%. Parcare 8.000€. Rezervare cu 2.000€. Consultanță bancară gratuită — identificăm cel mai mic cost total de finanțare din oferta bancară actuală. Vânzare directă de la sursă, fără comision. Titan-Pallady rămâne zona cu cel mai echilibrat raport dintre prețul de achiziție, calitatea ofertei comerciale și educaționale și accesul la metrou din estul Bucureștiului.`,
    ...
    puncteInteres: [
      ...
      { tip: 'medical', nume: 'Campus Medical Regina Maria Titan', distanta: '13 min pe jos' },
      { tip: 'parc', nume: 'Parcul IOR (Titan)', distanta: '5 min cu masina' },
      { tip: 'metrou', nume: 'Metrou Costin Georgian (M2)', distanta: '5 min cu masina' },
      { tip: 'mall', nume: 'IKEA Pallady', distanta: '6 min cu masina' },
      { tip: 'mall', nume: 'Park Lake Plaza', distanta: '6 min cu masina' },
      { tip: 'metrou', nume: 'Metrou Anghel Saligny (M2)', distanta: '8 min cu masina' },
      { tip: 'parc', nume: 'Parcul National 23 August', distanta: '10 min cu masina' },
    ],
    galerie: [],
...
Apartamentele de 2 camere din Neofort 42 se închiriază curent cu 900-1.100€/lună în zona Piața Muncii, generând randamente brute de 5,3-6,7% față de prețurile promoționale actuale. Apartamentele de 4 camere se adresează chirașilor premium — familii de expats și executivi care apreciază spațiul și localizarea semicentrală. Promoția este valabilă pentru stocul curent — prețurile se vor ajusta la finalizarea vânzărilor. Consultanță bancară gratuită. Vânzare directă, fără comision.`,
    ...
    puncteInteres: [
      { tip: 'metrou', nume: 'Metrou Piata Muncii (M3)', distanta: '700m' },
      { tip: 'metrou', nume: 'Metrou Dristor 2 (M2)', distanta: '850m' },
      { tip: 'parc', nume: 'Parcul National 23 August', distanta: '950m' },
      { tip: 'scoala', nume: 'Universitatea Hyperion', distanta: '14 min pe jos' },
      { tip: 'mall', nume: 'Kaufland Popa Nan', distanta: '14 min pe jos' },
      { tip: 'mall', nume: 'Park Lake Plaza', distanta: '3 min cu masina' },
      { tip: 'metrou', nume: 'Metrou Dristor 1 (M2)', distanta: '3 min cu masina' },
...
Cumpărătorii care au ales apartamentele cu curte la Neofort 28 au plătit o primă de 26.000-29.000€ față de unitățile standard — o diferență pe deplin justificată de raritatea configurației și de cererea ridicată. Pe piața secundară, apartamentele cu grădini private în blocuri noi se vând cu prime similare față de unități identice fără exterior, confirmând că această tipologie păstrează valoarea adăugată pe termen lung. Incinta împrejmuită cu acces controlat și videointerfon cu vedere nocturnă completează securitatea comunității. Parcare exterioară 7.500€, subterană 11.000€. Rezervare cu 2.000€. Consultanță bancară gratuită. Vânzare directă fără comision.`,
    ...
    puncteInteres: [
      ...
      { tip: 'metrou', nume: 'Metrou Costin Georgian (M2)', distanta: '9 min cu masina' },
      { tip: 'mall', nume: 'Park Lake Plaza', distanta: '10 min cu masina' },
      { tip: 'parc', nume: 'Parcul National 23 August', distanta: '15 min cu masina' },
    ],
    galerie: [],
...
13 apartamente înseamnă că vei cunoaște toți vecinii. Înseamnă costuri comune reduse. Înseamnă că administrarea clădirii este simplă și transparentă. Predare Septembrie 2026. Vânzare directă, fără comision.
...
Predarea estimată în Septembrie 2026 permite finalizarea procesului de finanțare bancară fără presiune de timp. Consultanța bancară Neofort IMO este gratuită și include compararea ofertelor de la toate băncile partenere pentru cel mai mic cost total de finanțare. Apartamentele în promoție — 2 camere de la 176.000€ față de 192.000€ standard — reprezintă o economie imediată de 8-16.000€ față de prețul de listă. Parcare subterană 25.000€. Vânzare directă, fără comision.`,
    ...
    puncteInteres: [
      { tip: 'mall', nume: 'Veranda Mall Obor', distanta: '250m' },
      { tip: 'metrou', nume: 'Metrou Piata Obor (M2)', distanta: '400m' },
      { tip: 'scoala', nume: 'Colegiul National Mihai Eminescu', distanta: '600m' },
      { tip: 'metrou', nume: 'Metrou Stefan cel Mare (M2)', distanta: '600m' },
      { tip: 'parc', nume: 'Lacul Tei / Parcul Tei', distanta: '800m' },
      { tip: 'parc', nume: 'Parcul Plumbuita', distanta: '13 min pe jos' },
...
Un argument final pentru Neofort 8 care merită menționat explicit: clasa energetică A nu este doar un certificat — înseamnă facturi de energie termică cu 20-30% mai mici față de clasa B, permanent, pe toți anii de locuire. La o factură medie de 200€/lună iarna, economia anuală este de 480-720€. Pe 20 de ani, economia cumulată depășește 10.000€ — o valoare concretă care justifică orice diferență de preț față de un imobil similar din clasa B. Parcare subterană cu lift 25.000€. Rezervare cu 2.000€. Consultanță bancară și juridică gratuită. Vânzare directă de la sursă, fără comision de agenție.`,
    ...
    puncteInteres: [
      { tip: 'scoala', nume: 'Universitatea Hyperion', distanta: '350m' },
      { tip: 'metrou', nume: 'Metrou Piata Iancului (M2)', distanta: '700m' },
      { tip: 'mall', nume: 'Kaufland Popa Nan', distanta: '900m' },
      { tip: 'metrou', nume: 'Metrou Dristor 2 (M2)', distanta: '14 min pe jos' },
      { tip: 'parc', nume: 'Parcul National 23 August', distanta: '14 min pe jos' },
      { tip: 'metrou', nume: 'Metrou Piata Muncii (M3)', distanta: '14 min pe jos' },
