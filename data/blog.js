...
export const ARTICOLE_LIST = [
  ...
  { slug: 'ghid-cumparare-apartament-nou', titlu: 'Ghid Complet 2026: Cum Cumperi un Apartament Nou de la Dezvoltator', data: '10 Martie 2026', dataISO: '2026-03-10', dataISO: '2026-03-10', citire: '13 min', image: '/blog/ghid-cumparare-apartament-nou-bucuresti.avif', tag: 'Ghid', tagColor: '#2d7a3a', rezumat: 'Toți pașii de la prima vizită până la predarea cheilor: ce verifici la contract, cum negociezi, ce capcane există și cum le eviți.', autor: 'Adriana Veselu', autorSlug: 'adriana-veselu', featured: false },
]
